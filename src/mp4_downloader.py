...
def download_youtube_video(url, download_path="../assets/videos", video_quality="best"):
    ydl_opts = {
...
download_path = input("Enter the download path (default is ../assets/videos): ")or "../assets/videos"
